...
Run-Exit-On-Error "poetry run pyinstaller --clean --onefile --add-data `"INSTRUCTIONS.md;.`" --workpath `"$WorkPath`" --name `"FlightUpdater_$Tag`" --paths `"src;..\glidinglib\src`" --hidden-import=tkcalendar `"$MainFile`""
